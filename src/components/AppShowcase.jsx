      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto">
          <a 
            ...
            className="text-primary-300 font-medium hover:text-primary-200 app-link inline-flex items-center whitespace-nowrap"
          >
            <span>View App</span>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1 inline-block flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
